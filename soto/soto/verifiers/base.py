...
class VerifierFactory:
    ...
    _registry = {}
    _module_map = {
        "clip": "soto.verifiers.clip_verifier",
        "image_reward": "soto.verifiers.image_reward_verifier",
        "dreamsim": "soto.verifiers.dreamsim_verifier",
        "aesthetic": "soto.verifiers.aesthetic_verifier",
        "pickscore": "soto.verifiers.pickscore_verifier",
        "cyclereward": "soto.verifiers.cyclereward_verifier",
        "hpsv2": "soto.verifiers.hpsv2_verifier",
        "likelihood": "soto.verifiers.likelihood_verifier",
        "grounded_sam": "soto.verifiers.spatial_verifier",
        "ensemble": "soto.verifiers.ensemble_verifier",
    }
    _loaded_modules = set()
