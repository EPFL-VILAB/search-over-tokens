...
logger = logging.getLogger("sot.infinity")
...
class InfinityARPrior(BaseARPrior):
    ...
    Implements the SoT ``BaseARPrior`` interface, enabling beam search,
    ...
    def generate_next_tokens(
        ...
        **kwargs,
        ...
        Translates between the SoT flat-token interface and Infinity's
